<?php
/**
 * Vanille forum embed plugin
 *
 * Syntax: <VANILLA> - will be replaced with Vanilla forum
 * 
 ...
 */
class syntax_plugin_vanilla extends DokuWiki_Syntax_Plugin {
    ...
    */
    function getInfo(){
        return array(
            ...
            'date'   => '2011-1-1',
            'name'   => 'Vanilla Forum Plugin',
            'desc'   => 'Embeds the forum here',
...
//    }
    ...
    */
    function connectTo($mode) {
      $this->Lexer->addSpecialPattern('<VANILLA>',$mode,'plugin_vanilla');
    } 
    ...
    */
    function render($mode, &$renderer, $data) {
        if($mode == 'xhtml'){
            $renderer->doc .= '<script type="text/javascript" src="/forum/plugins/embedvanilla/remote.js"></script>';
            // ptype = 'block'
            return true;
        }
        return false;
