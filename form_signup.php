...
#ss-form .form-choices { list-style:none; }
#ss-form .form-choices li {
	display: inline-block;
	vertical-align: top;
}
#ss-form .form-choices label { width:auto; }
#ss-form .form-choices label { text-align:left; }
#ss-form .form-entry { margin-bottom: 0; }
#ss-form label, #ss-form .ss-q-help { text-align:left; }
...
.ss-required-asterisk { text-align:right; color:black; font:10pt sans-serif; padding-left: 1pt; }
